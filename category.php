...
<body>
        ...
        ?>
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <a href="../postdescription.php?id=<?php echo htmlentities($row['pid']) ?>" class="btn btn-primary">Leer más &rarr;</a>
              </div>
  ...
  <script src="https://gobiernoabierto.bajacalifornia.gob.mx/blog/admin/contador/contador.js"></script>
  </head>
</body>
